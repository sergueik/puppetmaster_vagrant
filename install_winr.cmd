...
REM origin: https://github.com/conradjones/packer-serverspec-stages/blob/master/windows/install-winrm.cmd
...
@if errorlevel 1 echo ==^> WARNING: Error %ERRORLEVEL% was returned by: powershell -File %~dp0fixnetwork.ps1
