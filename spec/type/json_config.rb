...
module Serverspec
  module Type
    ...
    class JSONConfig < Base
      ...
      def real_initialize(file) # unfinished
        if os[:family] == 'redhat'
...
# :stdout, :stderr =  empty string
# http://www.rubydoc.info/gems/specinfra/2.51.1/Specinfra/CommandResult#stdout-instance_method
      end
