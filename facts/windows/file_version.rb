...
if Facter.value(:kernel) == 'windows'
  ...
  def registry_uninstall_version(product_guid)
    # Puppet 'A26152DC-07BA-4ACE-A86C-F8385DC55097'
    product_version = nil
    # ideally one would simply return Puppet::Provider::Package::Windows::Package().
    # https://github.com/puppetlabs/puppet/blob/master/lib/puppet/provider/package/windows/msi_package.rb
    # https://github.com/puppetlabs/puppet/blob/master/lib/puppet/provider/package/windows.rb
    # https://github.com/liamjbennett/puppet-win_facts/blob/master/lib/facter/windows_productkey.rb
    access = Win32::Registry::KEY_READ | 0x100

    Win32::Registry::HKEY_LOCAL_MACHINE.open("SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\{#{product_guid}}", access) do |reg|
