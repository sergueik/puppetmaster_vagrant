# origin: https://github.com/farag2/Windows-10-Setup-Script
# see also: https://habr.com/ru/post/465365/
# collection of disabling cmdlet calls and tweaks for a generic windows 10 machine
