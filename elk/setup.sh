...
if [ ! -d /etc/puppetlabs/code/environments/production/modules/file_concat ]; then
# puppet module install ispavailability/file_concat
 puppet module install electrical-file_concat

fi
if [ ! -d /etc/puppetlabs/code/environments/production/modules/apt ]; then
 puppet module install puppetlabs-apt --version '4.3.0'
fi
if [ ! -d /etc/puppetlabs/code/environments/production/modules/java ]; then
 puppet module install puppetlabs-java
fi
if [ ! -d /etc/puppetlabs/code/environments/production/modules/elasticsearch ]; then
 puppet module install elasticsearch-elasticsearch
fi
if [ ! -d /etc/puppetlabs/code/environments/production/modules/logstash ]; then
